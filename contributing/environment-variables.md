...
| DORKOS_A2A_ENABLED       | server | boolean             | `false`                   | Enable the A2A external gateway for cross-vendor agent communication. Requires `DORKOS_RELAY_ENABLED=true`.                                                                                              |
...
| DORKOS_TASKS_ENABLED     | server | boolean             | `false`                   | Enable the Pulse scheduler subsystem                                                                                                                                                                     |
