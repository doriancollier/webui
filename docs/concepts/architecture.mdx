...
The Express server exposes fifteen route groups including sessions, commands, health, config, files, git, Pulse scheduling, Relay messaging, and Mesh agent discovery. Routes are thin HTTP handlers — all business logic delegates to services or the active runtime.
