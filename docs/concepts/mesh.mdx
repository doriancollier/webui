...
DorkOS ships with three detection strategies:

- **claude-code** — Detects projects with a `CLAUDE.md` file at the project root (the Claude Code convention). Extracts a description from the first paragraph of `CLAUDE.md`.
- **cursor** — Detects projects with a `.cursor/` directory at the project root.
- **codex** — Detects projects with a `.codex/` directory at the project root.
