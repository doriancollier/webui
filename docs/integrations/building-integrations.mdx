...
<TypeTable type={{
  ...
  "relay_message": { type: "StreamEvent (Relay)", description: "Relay response chunk — contains a nested StreamEvent. Only emitted when DORKOS_RELAY_ENABLED=true" },
  "relay_receipt": { type: "StreamEvent (Relay)", description: "Delivery confirmation when a message is routed through Relay. Only emitted when DORKOS_RELAY_ENABLED=true" },
  "message_delivered": { type: "StreamEvent (Relay)", description: "Message delivery notification from the Relay transport. Only emitted when DORKOS_RELAY_ENABLED=true" },
}} />
