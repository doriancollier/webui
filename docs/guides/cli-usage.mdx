...
<TypeTable type={{
  ...
  "--dir, -d": { type: "string", description: "Default working directory", default: "Current directory" },
  "--boundary, -b": { type: "string", description: "Directory boundary — restricts file access to this path and its children", default: "Home directory" },
  "--tunnel, -t": { type: "boolean", description: "Enable ngrok tunnel for remote access", default: "false" },
  "--log-level, -l": { type: "string", description: "Log verbosity (fatal, error, warn, info, debug, trace)", default: "info" },
}} />
