...
<Steps>
  ...
  <Step>
    **Click Approve** to allow the action. Claude executes the tool and continues.
  </Step>
  <Step>
...
<Callout type="info">
Tool approvals have a **10-minute timeout**. If you don't respond, the tool call is automatically denied and Claude continues with a different approach.
</Callout>
