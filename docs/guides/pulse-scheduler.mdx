...
- **Cron expression** -- When the job should run (see [Cron Syntax](#cron-syntax) below). Choose from preset buttons or build a custom expression with the visual builder.
