...
function ConnectionIllustration() {
  return (
    ...
    >
      {/* Laptop */}
      <rect
        x="80" y="30" width="80" height="50" rx="4"
        className="fill-none stroke-current"
        strokeWidth="2"
      />
      <rect
        x="70" y="80" width="100" height="6" rx="2"
      ...
      {/* Phone (right) */}
      <rect
        x="195" y="35" width="28" height="45" rx="4"
        className="fill-none stroke-current"
        strokeWidth="1.5"
      />
      ...
      {/* Tablet (left) */}
      <rect
        x="10" y="30" width="40" height="55" rx="4"
        className="fill-none stroke-current"
        strokeWidth="1.5"
      />
      ...
      <line
        x1="160" y1="55" x2="195" y2="55"
        className="stroke-current opacity-40"
        strokeWidth="1.5"
        strokeDasharray="4 3"
      />
      <line
        x1="80" y1="55" x2="50" y2="55"
        className="stroke-current opacity-40"
        strokeWidth="1.5"
        strokeDasharray="4 3"
      />
