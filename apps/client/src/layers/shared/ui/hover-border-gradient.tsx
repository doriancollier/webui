...
const MOVING_MAP: Record<Direction, string> = {
  TOP: 'radial-gradient(20.7% 50% at 50% 0%, hsl(var(--primary) / 0.7) 0%, transparent 100%)',
  LEFT: 'radial-gradient(16.6% 43.1% at 0% 50%, hsl(var(--primary) / 0.7) 0%, transparent 100%)',
  BOTTOM:
    'radial-gradient(20.7% 50% at 50% 100%, hsl(var(--primary) / 0.7) 0%, transparent 100%)',
  RIGHT:
    'radial-gradient(16.2% 41.2% at 100% 50%, hsl(var(--primary) / 0.7) 0%, transparent 100%)',
};

const HIGHLIGHT =
  'radial-gradient(75% 181.2% at 50% 50%, hsl(var(--primary)) 0%, transparent 100%)';
...
>) {
  ...
  return (
    ...
    >
      <div
        className={cn(
          'z-10 w-auto rounded-[inherit] bg-primary px-4 py-2 text-sm font-medium text-primary-foreground',
          className,
        )}
      >
        {children}
      ...
      />
      <div className="absolute inset-[2px] z-[1] flex-none rounded-[inherit] bg-primary" />
    </Tag>
  );
}
