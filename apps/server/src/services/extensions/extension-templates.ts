...
export function activate(api: ExtensionAPI): void {
  ...
  // The settings tab for secrets is auto-generated by the host from
  // serverCapabilities.secrets in extension.json — no code needed here.
  api.registerComponent('dashboard.sections', '${name}-section', ${pascalName}Section, {
    priority: 50,
  });
}
