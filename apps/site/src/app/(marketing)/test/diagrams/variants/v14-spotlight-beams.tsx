...
const BEAMS: BeamDef[] = [
  ...
  { d: 'M -20 -20 L 820 440', dur: 6.0, delay: 2.8, width: 0.7, opacity: 0.4 },
];
  ...
  return (
    <>
      <defs>
        ...
        <linearGradient id={gradId} gradientUnits="userSpaceOnUse" x1="0" y1="0" x2="800" y2="0">
  ...
  return (
    <>
      ...
      >
        ...
        >
          {BEAMS.map((beam, i) => (
            <AnimatedBeam key={i} beam={beam} gradId={`v14-beam-grad-${i}`} />
          ))}
